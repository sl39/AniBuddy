...
import org.example.anibuddy.pet.PetCreateDTO;
...
import org.example.anibuddy.store.StoreRepository;
...
public class FollowingService {
	...
	public void toggleFollowing(UserEntity user, Integer storeId) {
