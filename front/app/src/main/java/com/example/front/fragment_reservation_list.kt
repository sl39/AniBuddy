 ...
 * Use the [fragment_reservation_list.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_reservation_list : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment_reservation_list.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            fragment_reservation_list().apply {
